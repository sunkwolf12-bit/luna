...
# 2. Pagos (Incluyendo DEPOSITO3 para que NO aparezcan como pendientes)
pagos_folios = set()
# Consideramos TODOS los folios de Efectivo (incluyendo el 3 que ya está registrado pero no depositado)
...
with open('Facturas_Pendientes_REALES.csv', 'w', encoding='utf-16') as f:
    f.write("Folio\tCliente\tMonto\n")
    pendientes_count = 0
...
print(f"CSV Generado con {pendientes_count} facturas.")
