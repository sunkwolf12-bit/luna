---
name: cobranza-quincenal-revision
description: "Revisión y conciliación de cobranza quincenal con cobradores (Proteg-rt): comparar relación/fotos del cobrador vs Excel del sistema (ENTREGADO), excluir pagos de $125 (endosos), calcular totales por día, detectar desfases de fecha vs diferencias reales (transferencias reflejadas después, pagos adelantados, folios faltantes) y generar un resumen final listo para explicar a cobrador/Control. Usar cuando Elena pida revisión quincenal, cuadrar cobranza, comparar relación vs sistema, o envíe Excel + fotos/folios."
---

# Revisión quincenal de cobranza (Proteg-rt)
...
Uso (ejemplo):
```bash
python3 skills/cobranza-quincenal-revision/scripts/resumen_sistema.py \
...
Si el Excel trae nombres de columnas distintos, ajustar los parámetros o pedir a Elena confirmación.
